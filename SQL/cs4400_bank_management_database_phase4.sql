...
-- Bank Management Project - Phase 4 - Physical Schema
...
create table success (
	procedure_status varchar(100) default null, -- "failed", "succeeded"
    procedure_message varchar(100) default null,
    procedure_id varchar(100) default null, -- the name of the procedure
    procedure_timestamp timestamp, -- when the procedure took place
    primary key (procedure_timestamp)
);
